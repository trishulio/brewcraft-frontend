    ...
    <ul className="metismenu list-unstyled" id="side-menu">
        ...
        <li>
            ...
            <ul className="sub-menu" aria-expanded="false">
                <li><Link to="/brews">Overview <span className="badge badge-pill badge-primary float-right">2</span></Link></li>
                <li><Link to="/#">Start a brew</Link></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul className="sub-menu" aria-expanded="false">
                    <li><Link to="/raw-materials">Overview</Link></li>
                    <li><Link to="ui-buttons">Record Transaction</Link></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul className="sub-menu" aria-expanded="false">
                    <li><Link to="/packaging">Overview</Link></li>
                    <li><Link to="/#">Record Transaction</Link></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul className="sub-menu" aria-expanded="false">
                <li><Link to="/finished-goods">Overview</Link></li>
                <li><Link to="/#">Record Transaction</Link></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul className="sub-menu" aria-expanded="false">
                <li><Link to="/equipment"> Overview</Link></li>
        ...
        <li>
            <Link to="/facility" className="waves-effect">
                <i className="mdi mdi-clipboard"></i><span className="badge badge-pill badge-primary float-right">2</span>
                <span>Facility</span>
            </Link>
        </li>
    </ul>
