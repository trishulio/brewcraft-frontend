        ...
        <React.Fragment>
            <Dropdown isOpen={isOpen} toggle={() => setIsOpen(!isOpen)} className="d-inline-block">
                ...
                <DropdownMenu right>
                    ...
                    <DropdownItem tag="a" onClick={onSignOut} className="text-danger"><i className="mdi mdi-power font-size-17 text-muted align-middle mr-1 text-danger"></i> Logout</DropdownItem>
                </DropdownMenu>
            </Dropdown>
        </React.Fragment>
        );
