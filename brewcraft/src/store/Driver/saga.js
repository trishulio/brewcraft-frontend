...
function* editDelivery(action) {
  yield put({ type: EDIT_DELIVERY_SUCCESS, payload: { ...action.payload } });
}
//

function* deleteDelivery(action) {
  yield put({ type: DELETE_DELIVERY_SUCCESS, payload: { ...action.payload } });
}

export default function* Delivery() {
  yield takeLatest(FETCH_DELIVERY_REQUEST, fetchDelivery);
  yield takeLatest(ADD_DELIVERY_REQUEST, addDelivery);
  yield takeLatest(EDIT_DELIVERY_REQUEST, editDelivery);
  yield takeLatest(DELETE_DELIVERY_REQUEST, deleteDelivery);
}
