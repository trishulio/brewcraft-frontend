...
class LatestOrders extends Component {
    constructor(props) {
        ...
        this.state = {
            orders : [
                { imgUrl : fantasticLager, id : "12354781", name : "Fantastic Lager", status : "Delivered", amount : "185", date : "5/12/2016", color : "success" },
                { imgUrl : fantasticLager, id : "52140300", name : "Fantastic Lager", status : "Delivered", amount : "1,024", date : "5/12/2016", color : "success" },
                { imgUrl : deliciousIpa, id : "96254137", name : "Delicious IPA", status : "Cancel", amount : "657", date : "5/12/2016", color : "danger" },
                { imgUrl : specialAle, id : "12365474", name : "Special Ale", status : "Shipped", amount : "8451", date : "5/12/2016", color : "warning" },
                { imgUrl : fantasticLager, id : "85214796", name : "Fantastic Lager", status : "Delivered", amount : "584", date : "5/12/2016", color : "success" },
                { imgUrl : warmStout, id : "12354781", name : "Warm Stout", status : "Delivered", amount : "185", date : "5/12/2016", color : "success" },
            ]
        }
    }
