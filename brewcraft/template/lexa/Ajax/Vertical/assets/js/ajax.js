$(document).on("click", ".metismenu li a, .navbar-nav  li a", function(e) {
	...
	if (page == "javascript:void(0);" || page == "javascript: void(0);") return false;
...
function my_ajax(page) {
	...
	if(page === "index.html" || "")
	{
		document.title = "Dashboard | Lexa - Responsive Bootstrap 4 Admin Dashboard";

	   $('#dashboard_li').addClass('mm-active');
	   $('#dashboard_anchor').addClass('active');
	...
	else
	{
		...
		document.title = title1.charAt(0).toUpperCase() + title1.slice(1) + " | Lexa - Responsive Bootstrap 4 Admin Dashboard";
	}
