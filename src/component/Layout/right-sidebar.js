                ...
                <div className="right-bar">
                    <PerfectScrollbar className="h-100">
                        ...
                        <div className="p-4">
                            ...
                            <br />
                            <div className="radio-toolbar">
                                <span id="radio-title">Layout Width</span>
                                <br />
                                <input
                                    type="radio"
                                    id="radioFluid"
                                ...
                                <React.Fragment>
                                    <div className="radio-toolbar">
                                        ...
                                        <input
                                            ...
                                            value="light"
                                            checked={
                                                this.state.topbarTheme ===
                                                "light"
                                            }
                                            onChange={this.changeTopbarTheme}
                                        />

                                        <label htmlFor="radioThemeLight">
                                            Light
                                        </label>
                                        {"   "}
                                        <input
                                        ...
                                        "vertical" ? null : (
                                            <>
                                                ...
                                                />
                                                <label htmlFor="radioThemeColored">
                                                    Colored
                                                </label>{" "}
                                            </>
                                        )}
                                    ...
                                    <div className="radio-toolbar">
                                        ...
                                        <label htmlFor="leftsidebarThemelight">
                                            Light
                                        </label>
                                        {"   "}
                                        <input
                                        ...
                                        />
                                        <label htmlFor="leftsidebarThemedark">
                                            Dark
                                        </label>
                                        {"   "}
                                        <input
                                        ...
                                        />
                                        <label htmlFor="leftsidebarThemecolored">
                                            Colored
                                        </label>
                                    </div>
                                    <hr />
