...
export default function Facility() {
    ...
    const tableRows = React.useMemo(() => {
        return map(facilities, (currentList) => {
            return {
                ...omit(
                    { ...currentList, ...omit(currentList.address, "id") },
                    ["address", "equipment", "storages"]
                ),
            };
        });
    }, [facilities]);
    ...
    const dialogOpenEditFn = (selectRows) => {
        ...
        if (IndexVlaue !== -1) {
            setEditForm({
                edit: true,
                formData: { ...facilities[IndexVlaue] },
            });
            setIsOpen(true);
        }
        ...
        return (
            <div className="text-center">
                ...
                <Button
                    size="sm"
                    color="warning"
                    onClick={() => dialogOpenDeleteFn(row)}
                >
                    Delete
                </Button>
            </div>
          ...
          <Card>
            ...
            {!!isOpen && (
                ...
                >
                    <FacilityForm
                        formModel={
                            editForm.edit ? editForm.formData : formModel
                        }
                        close={dialogCloseFn}
