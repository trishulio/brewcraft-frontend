        ...
        <React.Fragment>
            ...
            <div className="mb-3">
                <CommonTable>
                    ...
                    {
                        finishedGoods && map(finishedGoods, (finishedGood, index) => (
                            <tr key={index}>
                                <td style={{ width: "2rem" }}>
                                    <div className="d-flex align-items-center vertical-center">
                                        {editable && <Input
                                            ...
                                            onChange={e => {
                                                if (e.target.checked) {
                                                    setSelectedListItems([...selectedListItems, index])
                                                } else {
                                                    setSelectedListItems(selectedListItems.filter(item => item !== index))
                                                }
                                            }}
                                            checked={selectedListItems.includes(index) && editable}
                                        />}
                                    </div>
                                </td>
                                ...
                                <td>{finishedGood.mixturePortions[0].quantity.value} {finishedGood.mixturePortions[0].quantity.symbol}</td>
                                <td>-</td>
                            </tr>
                        ))
                    }
