...
import { Media, Row, Col, Card, CardBody } from "reactstrap";
    ...
    const dummydata = [
        {
            ...
            company: "Upwork",
            last_active:
                "Sat Sep 26 2020 13:22:28 GMT+0530 (India Standard Time)",
            phone: 9654106121,
            ...
            <Row>
                        ...
                        <CardBody>
                            ...
                            <Media className="mb-4">
                                ...
                                <Media className="align-self-center" body>
                                    ...
                                    <p className="mt-2">
                                        <b>Phone</b>: {get(detail, "phone")}
                                    </p>
                                    <p>
                                        <b>Company</b>: {get(detail, "company")}
                                    </p>
                                    <p>
                                        <b>License Plate</b>:{" "}
                                        {get(detail, "license_plate")}
                                    </p>
                                    <p>
                                        <b>Last Active</b>:{" "}
                                        {get(detail, "last_active")}
                                    </p>
                                    <p>
                                        <b>Last Location</b>:{" "}
                                        {get(detail, "last_location")}
                                    </p>
                                </Media>
                            </Media>
                        </CardBody>
                ...
                <Col>
                    <Card>
                        <CardBody>
                            {detail && (
                                <Vechicles driverid={get(detail, "id")} />
                            )}
                        </CardBody>
                    </Card>
                </Col>
