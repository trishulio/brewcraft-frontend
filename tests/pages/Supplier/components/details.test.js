    ...
    describe("render()", () => {
        test("renders the Details component", () => {
            const supplierDetailsComp = mount(
                <Provider store={store}>
                    <BrowserRouter>
                        <SupplierDetails editable={false} />
                    </BrowserRouter>
                </Provider>
            );
        ...
        test("Dispatch supplierName is getting on input change", () => {
            const supplierDetailsComp = mount(
                <Provider store={store}>
                    <BrowserRouter>
                        <SupplierDetails editable={true} />
                    </BrowserRouter>
                </Provider>
            );

            supplierDetailsComp
                .find('input[name="supplierName"]')
                .simulate("change");
        ...
        test("Dispatch supplierAddressLine1 is getting on input change", () => {
            ...
            supplierDetailsComp
                .find('input[name="supplierAddressLine1"]')
                .simulate("change");
        ...
        test("Dispatch supplierAddressLine2 is getting on input change", () => {
            ...
            supplierDetailsComp
                .find('input[name="supplierAddressLine2"]')
                .simulate("change");
        ...
        test("Dispatch supplierAddressCity is getting on input change", () => {
            ...
            supplierDetailsComp
                .find('input[name="supplierAddressCity"]')
                .simulate("change");
        ...
        test("Dispatch supplierAddressProvince is getting on input change", () => {
            ...
            supplierDetailsComp
                .find('input[name="supplierAddressProvince"]')
                .simulate("change");
        ...
        test("Dispatch supplierAddressPostalCode is getting on input change", () => {
            ...
            supplierDetailsComp
                .find('input[name="supplierAddressPostalCode"]')
                .simulate("change");
        ...
        test("Dispatch supplierAddressCountry is getting on input change", () => {
            ...
            supplierDetailsComp
                .find('input[name="supplierAddressCountry"]')
                .simulate("change");
